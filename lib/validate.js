...
exports = module.exports = function (options) {
    ...
    let staticDirectory, //static_files工程绝对地址
        webappDirectoryList = [], //所有的webapp工程
        jsCompileList = [], //待编译的js文件集合
        cssCompileList = []; //模板中引用的所有css文件集合
    ...
    staticDirectory = global.staticDirectory = utils.normalizePath(staticFilesDirectory);
