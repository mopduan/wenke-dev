...
/**
 * 获取Babel公用参数
 * @returns {{cacheDirectory: boolean, presets: [*,*], plugins: [*,*,*,*,*,*,*], compact: boolean}}
 */
function getBabelSettings() {
    ...
    return {
        cacheDirectory: true,
        presets: [nodeModulesDir + 'babel-preset-latest', nodeModulesDir + 'babel-preset-react'],
        plugins: [
            [nodeModulesDir + 'babel-plugin-transform-es2015-template-literals', LOOSE],
            [nodeModulesDir + 'babel-plugin-transform-es2015-classes', LOOSE],
            [nodeModulesDir + 'babel-plugin-transform-es2015-computed-properties', LOOSE],
            [nodeModulesDir + 'babel-plugin-transform-es2015-for-of', LOOSE],
            [nodeModulesDir + 'babel-plugin-transform-es2015-spread', LOOSE],
            [nodeModulesDir + 'babel-plugin-transform-es2015-destructuring', LOOSE],
            [nodeModulesDir + 'babel-plugin-transform-es2015-modules-commonjs', LOOSE]
        ],
        compact: false
    };
}

exports.getBabelSettings = getBabelSettings;
...
function getLoaders() {
    return [
        ...
        {
            test: /\.(html|tpl)$/i, loader: "raw-loader"
        },
        {
